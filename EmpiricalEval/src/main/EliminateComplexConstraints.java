...
public class EliminateComplexConstraints {
	 ...
	 public static void main(String[] args) {		
		...
		if(args.length == 0) {
			System.err.println("You need to provide either files or folders of files that you would like to transform.");
			return;
		}
		...
		for(String fileName : args) {
			...
			for(File file : listOfFiles) {
				...
				int nComplexConstraints = fm.getConstraintCount() - Collections.frequency(new ArrayList<ConstraintType>(Utils.classify(fm).values()), 
				...
				/**
				 * You can choose between CNFConverter, NNFConverter, or CombinedConverter...
				 */
